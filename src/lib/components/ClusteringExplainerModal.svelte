		...
		>
			...
			>
				...
				<div class="flex items-center justify-between p-4 border-b border-primary-100">
					<h2 id="clustering-title" class="text-lg font-semibold text-primary">
				...
				<div class="p-5 space-y-5">
					...
					<div class="flex justify-center" aria-hidden="true">
						<svg class="clustering-illustration" viewBox="0 0 280 120" width="280" height="120">
							...
							<circle
								class="dot dot-cluster-a dot-a1"
								cx="30"
								cy="20"
								r="6"
								fill="#3b82f6"
							...
							/>
							<circle
								class="dot dot-cluster-a dot-a2"
								cx="80"
								cy="90"
								r="6"
								fill="#6366f1"
							...
							/>
							<circle
								class="dot dot-cluster-a dot-a3"
								cx="50"
								cy="55"
								r="6"
								fill="#8b5cf6"
							...
							/>
							<circle
								class="dot dot-cluster-a dot-a4"
								cx="15"
								cy="70"
								r="5"
								fill="#a78bfa"
							...
							/>
							<circle
								class="dot dot-cluster-a dot-a5"
								cx="75"
								cy="30"
								r="5"
								fill="#818cf8"
							...
							<circle
								class="dot dot-cluster-b dot-b1"
								cx="200"
								cy="25"
								r="6"
								fill="#10b981"
							...
							/>
							<circle
								class="dot dot-cluster-b dot-b2"
								cx="250"
								cy="80"
								r="6"
								fill="#14b8a6"
							...
							/>
							<circle
								class="dot dot-cluster-b dot-b3"
								cx="220"
								cy="65"
								r="6"
								fill="#06b6d4"
							...
							/>
							<circle
								class="dot dot-cluster-b dot-b4"
								cx="265"
								cy="35"
								r="5"
								fill="#34d399"
					...
					<div class="space-y-3 text-sm text-primary-600">
						<p>
							{s('stories.clusteringModal.communityFeedsDescription') ||
								'The RSS feeds for this category are put together by community members, not the Kagi team.'}
						</p>
						<p>
							{s('stories.clusteringModal.clusteringDescription') ||
								'When articles from different feeds cover the same topic, they get grouped into a story. The more feeds that pick up on something, the stronger the signal.'}
						</p>
						<p>
							{s('stories.clusteringModal.noClusterDescription') ||
								"If feeds don't have enough overlap in what they're covering, no clusters form and no stories show up. This is normal and happens more with niche or regional categories."}
						</p>
						<p>
							{s('stories.clusteringModal.fullyAutomaticDescription') ||
								'Nobody picks or chooses what appears. The whole process runs automatically, from pulling in feeds to clustering to writing summaries.'}
						</p>
					</div>
					...
					<div class="relative">
						...
						<div class="relative flex justify-center text-xs">
							<span class="px-2 bg-modal-bg text-primary-600">
					...
					<div class="text-center space-y-2">
						<p class="text-sm text-primary-600">
							{s('stories.clusteringModal.helpImproveDescription') ||
								'Adding more feeds makes clustering work better. You can suggest new ones on GitHub.'}
						</p>
						<a
							href={KITE_PUBLIC_URL}
							target="_blank"
							rel="noopener noreferrer"
							class="inline-flex items-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg transition-colors focus-visible-ring"
						>
